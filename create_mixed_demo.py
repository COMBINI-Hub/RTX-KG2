#!/usr/bin/env python3
"""
create_mixed_demo.py: Create a demo subset with BOTH PrimeKG and SemMedDB
...
Usage: python create_mixed_demo.py
"""
...
def create_mixed_demo():
    """Create a demo subset with both PrimeKG and SemMedDB"""
    date("Creating mixed PrimeKG + SemMedDB demo subset")
    ...
    try:
        ...
        kg2_util.close_kg2_jsonlines(nodes_info, edges_info, 'mixed_demo_nodes.jsonl', 'mixed_demo_edges.jsonl')
    
    date("Finished creating mixed demo subset")
